# Peter Kaminski Claude skills  

## 2026-02-08 on the OGM Email list
...
Now for the next part of moving into Claude: getting the profile from ChatGPT, enhanced by a conversation with Claude, into Claude more systemically. I think just having a conversation will not affect other conversations much.
...
### Step 2, build a "Think with Klaus" skill
